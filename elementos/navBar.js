...
<a class="navbar-brand" id="logo" href="index.php"><img id="logoImg" src="./imagenes/logo.png" alt="" /></a>
...
<div class="navbar-collapse" id="navbarNavAltMarkup">
  <div class="navbar-nav">
    <a class="nav-link" id="cambios" aria-current="page" href="index.php">Inicio</a>
    <a class="nav-link" id="cambios" href="premier.php">Premier League</a>
    ...
    <a class="nav-link" id="cambios" href="predicciones.php">Fichajes</a>
  </div>
