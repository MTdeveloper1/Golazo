    ...
    <div class="contenedorArticulo">
      ...
      <div class="infoContainer">
        <p class="pContainer">
          ...
          Al terminar el partido se le pregunto a Foden como se sentía en el club y con Pep, el respondió: "Es el mejor entrenador que le puede tocar a un jugador". 
          Foden aprendío mucho de Guardiola quien le tiene un cariño especial, tanto así que dijo que después de Messi es la mejor promesa que vio con sus propios ojos.
          Ahora el City seguirá luchando para quedarse lo mas solitario que pueda en la punta.
        </p>
        <a href="">Ver más</a>
      </div>
    </div>
